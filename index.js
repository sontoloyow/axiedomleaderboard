...
function buildPage(weekVal, sortCol, sortDir) {
  ...
  const lbRows = rows.map(p => {
    ...
    const nameLink = `<a href="${href}" target="_blank" style="color:inherit;text-decoration:none;border-bottom:1px dashed #555;padding-bottom:1px" onmouseover="this.style.color='#C8FF00'" onmouseout="this.style.color=''">${safeName}${star}</a>`;
